...
class Metadata:
    ...
    def get_metadata(self):
        ...
        header = csvreader.__next__() # modified from next to __next__
...
class Transcript:
    ...
    def __init__(self, swda_filename, metadata):
        ...
        # Get the file rows:
        rows = list(csv.reader(open(self.swda_filename, 'r')))
        ...
        for key, val in transcript_metadata.items(): # items from iteritems
...
class Utterance:
    ...
    def __init__(self, row, transcript_metadata):
        ...
        ##################################################
        # Utterance data:
        for i in range(len(Utterance.header)): # range from xrange
